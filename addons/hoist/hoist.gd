"""
Resource which you export at the root of scene in which you wish to use hoisted variables.
It stores information about which variables are hoisted, and is also customized in the 
properties panel.
"""
